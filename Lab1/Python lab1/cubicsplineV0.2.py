...
comp_t_array, comp_x_array, comp_y_array, comp_v_array = data_util.get_array_from_files_with_raw_length("Lab1/Python lab1/Raw_data_exp", 5)
...
comp_x_array_mod = comp_x_array
comp_v_array_mod = comp_v_array
...
plt.title('')
plt.xlabel('$x$ [m]',fontsize=20)
plt.ylabel('$N/G(x)$ [N]',fontsize=20)
plt.grid()
#plt.show()
